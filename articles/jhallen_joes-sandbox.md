...
## [(L)](https://github.com/jhallen/joes-sandbox/blob/master/editor-perf/readme.md#memory-used-when-loading-helloc-with-no-syntax-highlighting)Memory used when loading "hello.c" with no syntax highlighting
