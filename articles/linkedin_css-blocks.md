...
A Block may specify it extends another Block in its [object Object] selector to inherit and extend all the class and state implementations therein.
...
}.my-class { /* ... */ }.my-class[state|my-state] { /* ... */ }
