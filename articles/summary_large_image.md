...
### [The tl;dr](https://images.guide/#the-tldr)
...
- [Introduction](https://images.guide/#introduction)
- [How can I tell if my images need to be optimized?](https://images.guide/#do-my-images-need-optimization)
- [How do I choose an image format?](https://images.guide/#choosing-an-image-format)
- [The humble JPEG](https://images.guide/#the-humble-jpeg)
- [JPEG compression modes](https://images.guide/#jpeg-compression-modes)
    - [The advantages of Progressive JPEGs](https://images.guide/#the-advantages-of-progressive-jpegs)
    - [Who's using Progressive JPEGs in production?](https://images.guide/#whos-using-progressive-jpegs-in-production)
    - [The disadvantages of Progressive JPEGs](https://images.guide/#the-disadvantages-of-progressive-jpegs)
    - [How do you create Progressive JPEGs?](https://images.guide/#how-to-create-progressive-jpegs)
    - [Chroma (or Color) Subsampling](https://images.guide/#chroma-subsampling)
    - [How far have we come from the JPEG?](https://images.guide/#how-far-have-we-come-from-the-jpeg)
    - [Optimizing JPEG Encoders](https://images.guide/#optimizing-jpeg-encoders)
    - [What is MozJPEG?](https://images.guide/#what-is-mozjpeg)
    - [What is Guetzli?](https://images.guide/#what-is-guetzli)
    - [How does MozJPEG compare to Guetzli?](https://images.guide/#mozjpeg-vs-guetzli)
    - [Butteraugli](https://images.guide/#butteraugli)
- [What is WebP?](https://images.guide/#what-is-webp)
    - [How does WebP perform?](https://images.guide/#how-does-webp-perform)
    - [Who's using WebP in production?](https://images.guide/#whos-using-webp-in-production)
    - [How does WebP encoding work?](https://images.guide/#how-does-webp-encoding-work)
    - [WebP browser support](https://images.guide/#webp-browser-support)
    - [How do I convert my images to WebP?](https://images.guide/#how-do-i-convert-to-webp)
    - [How do I view WebP images on my OS?](https://images.guide/#how-do-i-view-webp-on-my-os)
    - [How do I serve WebP?](https://images.guide/#how-do-i-serve-webp)
- [SVG optimization](https://images.guide/#svg-optimization)
- [Avoid recompressing images with lossy codecs](https://images.guide/#avoid-recompressing-images-lossy-codecs)
- [Reduce unnecessary image decode and resize costs](https://images.guide/#reduce-unnecessary-image-decode-costs)
    - [Delivering HiDPI images using `srcset`](https://images.guide/#delivering-hidpi-with-srcset)
    - [Art direction](https://images.guide/#art-direction)
- [Color management](https://images.guide/#color-management)
- [Image spriting](https://images.guide/#image-sprites)
- [Lazy-load non-critical images](https://images.guide/#lazy-load-non-critical-images)
- [Avoiding the `display: none;` trap](https://images.guide/#display-none-trap)
- [Does an image processing CDN make sense for you?](https://images.guide/#image-processing-cdns)
- [Caching image assets](https://images.guide/#caching-image-assets)
- [Preloading critical image assets](https://images.guide/#preload-critical-image-assets)
- [Performance Budgets For Images](https://images.guide/#performance-budgets)
- [Closing recommendations](https://images.guide/#closing-recommendations)
- [Trivia](https://images.guide/#trivia)
...
![Fewer images per page create more conversions. 19 images per page on average converted better than 31 images per page on average.](../_resources/d36e4346660a2d53b2d03e3d0a3eeefb.jpg)
...
![Image optimization covers a number of different techniques](../_resources/8e41c59f7452099c98b3bb8834a6439e.jpg)
...
![A histogram of potential image savings from the HTTP Archive validating the 30KB of potential image savings at the 95th percentile.](../_resources/dd10e2f402576fbe8f19c9cb68b79d93.jpg)

Per the [HTTP Archive](http://jsfiddle.net/rviscomi/rzneberp/embedded/result/), per-image savings at the 95th percentile (looking at the Cumulative Distribution Function) are 30KB!

There's plenty of room for us to collectively optimize images better.

![ImageOptim in use on Mac with a number of images that have been compressed with savings over 50%](../_resources/e5444ed8cb7f304f4e6b2bc08cad6530.jpg)
...
![WebPage test supports auditing for image compression via the compress images section](../_resources/fa76a1bec3562f0a140d28765af0ebdf.jpg)
...
![image compression recommendations from webpagetest](../_resources/67391268f241ee45e5082231199fc7a9.jpg)
...
![Lighthouse audit for HBO.com, displaying image optimisation recommendations](../_resources/174f3f564971be9134e6e3854c6976a9.jpg)
...
![vector vs raster images](../_resources/fee636892213eca36e4a188f09afb1d8.png)
...
![JPEG compression artifacts can be increasingly perceived as we shift from best quality to lowest](../_resources/c8729c22e2cc4f05d4eff98341657ff1.jpg)
...
![baseline JPEGs load top to bottom](../_resources/1cfa68c143be2ba5299ea19b51f67b93.jpg)
...
![progressive JPEGs load from low-resolution to high-resolution](../_resources/267332c183d55d03592828c001239b8b.jpg)
...
![impact to wait time of switching to progressive jpeg](../_resources/61f2674c1021c97bd4a0eede21ad294b.png)
...
![Pinterests JPEGs are all progressively encoded. This optimizes the user experience by loading them each scan-by-scan.](../_resources/223d1de56941c8a834b52b82e7ade9d2.png)
...
![photoshop supports exporting to progressive jpeg from the file export menu](../_resources/871988df1ca4f96fdb1ad6abaae3fed1.jpg)
...
![signal = chroma + luma](../_resources/7a370d6312bd53b1a5f86ac703106ce6.jpg)
...
![JPEG includes support for numerous subsampling types: none, horizontal and horizontal and vertical.](../_resources/ef9a33334da4f3138e19079915307209.jpg)
...
![Chrome subsampling configurations for a JPEG at quality 80.](../_resources/4cfd3e5e4ec2712b6fe64141c3c9a063.jpg)
...
![Be careful when using heavy subsampling with images containing text](../_resources/0fb292763ea71e77a6b734f660618447.jpg)
...
![modern image formats compared based on quality.](../_resources/d705c09fb9a08c3006c05d95197d452d.jpg)
...
![mozjpeg being run from the command-line](../_resources/4738c8fa0be5f4dd513f93708517d593.jpg)

![mozjpeg compression at different qualities. At q=90, 841KB. At q=85, 562KB. At q=75, 324KB. Similarly, Butteraugli and SSIM scores get slightly worse as we lower quality.](../_resources/01fe3ddd5a3e5bf1f5167dd5d569f535.jpg)
...
![guetzli being run from gulp for optimisation](../_resources/449a3f54aa9fa78d0272b27b048bb433.jpg)
...
![comparison of guetzli at different qualities. q=100, 945KB. q=90, 687KB. q=85, 542KB.](../_resources/4a7b2a7619d15f885de5f88dfe4de646.jpg)
...
![butteraugli validating an image of a parrot](../_resources/2069ab988bd4262ce8573bc569e8af9f.jpg)
...
![butteraugli being run from the command line](../_resources/ff36d99263e7dbada57de81454278cab.jpg)
...
![comparison of webp at different quality settings. q=90, 646KB. q=80= 290KB. q=75, 219KB. q=70, 199KB](../_resources/e82c85a6d755721b030bdd22385ee97f.jpg)
...
![WebP stats at Google: over 43B image requests a day](../_resources/188f62f11a228d9cad8684d63c537b7c.jpg)
...
![Macro-blocking example of a Google Doodle where we break a range of pixels down into luma and chroma blocks.](../_resources/0b68ccc7b2ed03e0f270afa42fe83d7b.png)
...
![Google Doodle example of a segment displaying the row, target block and column L when considering a prediction model.](../_resources/babe2d21f3233f3cbb156ac6f98dce9a.png)
...
![XNConvert app on Mac where a number of images have been converted to WebP](../_resources/f2526e5e1314ffa4e3bf423933680c99.png)
...
![Desktop on a mac showing a WebP file previewed using the Quick Look plugin for WebP files](:/047fad25eb742c256bc782999d8cb5bc)
...
![The Chrome DevTools Network panel displaying the waterfall for the Play Store in Chrome, where WebP is served.](:/e0b3b0fc062a1031b51d7f5247be71e6)
...
![While the Play store delivers WebP to Blink, it falls back to JPEGs for browsers like Firefox.](../_resources/364e9b671efe6838622b9559019966bc.jpg)
...
![Animated GIF vs. Video: a comparison of file sizes at ~equivalent quality for different formats.](../_resources/b66acd9f31a2edbd1a256d1890c7cde5.jpg)
...
![svgo](:/f31c2865b681145e2ac44104d1648ccd)
...
[SVGO](https://github.com/svg/svgo) is a Node-based tool for optimizing SVG. SVGO can reduce file-size by lowering the *precision* of numbers in yourdefinitions. Each digit after a point adds a byte and this is why changing the precision (number of digits) can heavily influence file size. Be very very careful with changing precision however as it can visually impact how your shapes look.

![where svgo can go wrong, oversimplifying paths and artwork](:/908b89774342621c57ce90acbee838e7)
...
![before and after running an image through svgo](:/519a956fe31e8fbe0bf63a428c811385)
...
![the smallest version of the new google logo was only 305 bytes in size](../_resources/4fe63c160e1123d1af541b1208bf0d06.jpg)
...
![generational loss when re-encoding an image multiple times](../_resources/3a37039f007aaa9ab705828df51fd72a.jpg)
...
![There are many steps involved in a browser grabbing an image specified in a tag and displaying it on a screen. These include request, decode, resize, copy to GPU and display.](:/18ffe940904e67b82e61e59a36cc256b)
...
![image decode costs shown in the chrome devtools](../_resources/ecbd3cb9a98b711c20f065d685f34c12.jpg)

Browsers have to go through a number of steps to paint images on the screen. In addition to fetching them, images need to be decoded and often resized. These events can be audited in the Chrome DevTools [Timeline](https://developers.google.com/web/tools/chrome-devtools/evaluate-performance/performance-reference).
...
![Decoding images can be incredibly costly on average and lower-end mobile hardware](../_resources/4240e1ad0243080b9c7c000c2a6ac6ef.jpg)
...
![Chrome DevTools Timeline/Performance panel highlighting image decode times before and after Twitter Lite optimized their image pipeline. Before was higher.](../_resources/0dadd2d7593979b94a0087f5c5aac4fa.jpg)
...
![A diagram of the device pixel ratio at 1x, 2x and 3x. Image quality appears to sharpen        as DPR increases and a visual is shown comparing device pixels to CSS pixels.](../_resources/4880437fb13cd5b413d15232eb54c317.jpg)
...
**Note:** You can learn more about Device Pixel Ratio and responsive images in this free [Udacity](https://www.udacity.com/course/responsive-images--ud882) course and the [Images](https://developers.google.com/web/fundamentals/design-and-ui/responsive/images) guide on Web Fundamentals.
...
![responsive art direction in action, adapting to show more or less of an image in a cropped manner depending on device](:/4e5afe5e60204dc9aea06e030215c8f9)
...
![sRGB, Adobe RGB and ProPhoto RGB](../_resources/63136115f706fc2b108a5f3f7de9ed7c.jpg)
...
![sRGB, Adobe RGB and ProPhoto RGB](../_resources/ddcbbd124531c46c5d29dff748c4f7bf.jpg)
...
![sRGB, Adobe RGB and ProPhoto RGB](../_resources/4e51d6dec0d6e64877ceb07aa24e75f9.jpg)
...
![Image sprites are still widely used in large, production sites, including the Google homepage.](../_resources/a90a12a34feaadd8aae7671ff973bc38.jpg)
...
![lazy-loading images](../_resources/251b6a34572ebbcca1cb3190c58cf0cb.jpg)
...
![inline previews for images on medium.com](../_resources/9054db155258fb17645c0123ffff013d.jpg)
...
For the web version of this book, I paired Lazysizes (athough you can use any alternative) with Cloudinary for on-demand responsive images. This allowed me the freedom to experiment with different values for scale, quality, format and whether or not to progressively load with minimal effort:

![Cloudinary supports on-demand control of image quality, format and several other features.](../_resources/7dfbb72e13bc75ec5abbd23ad65fee1c.jpg)
...
![Images hidden with display:none still get fetched](../_resources/13fb389914514c11caecb16553ea7d95.jpg)
...
![cloudinary media library](../_resources/9155e7a4d140e6a98bfa43b5c5125c4b.jpg)
...
![Philips use link rel=preload to preload their logo image](../_resources/952c9f1e6545eb6551370eef3289ba47.jpg)
...
![The FT using preload. Displayed are the WebPageTest before and after traces showing improvements.](../_resources/3d477dc2b96d926f1ab4ba191dcfcf8d.jpg)
...
## [Web Performance Budgets For Images](https://images.guide/#performance-budgets)
...
![SpeedCurve image size monitoring.](../_resources/be08976eb86c399d45e65f02395a08fd.jpg)
...
![Calibre supports bugets for image sizes.](../_resources/b482b9b173cab6cc74366326c7c9d085.jpg)
