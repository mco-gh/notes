...
> Any sufficiently complicated machine learning system contains an ad-hoc, informally-specified, bug-ridden, slow implementation of half of a programming language.> [> 1](https://julialang.org/blog/2017/12/ml&pl#fn:greenspun)
...
![](../_resources/60e4e2420f2401e7e5a7cddde7081b56.png)
...
[![machine_learning_2x.png](../_resources/81e8de0401b56910c558e2fc531cf776.png)](https://xkcd.com/1838/)
...
1.   After [Philip Greenspun](https://en.wikipedia.org/wiki/Greenspun%27s_tenth_rule) [↩](https://julialang.org/blog/2017/12/ml&pl#fnref:greenspun)

2.   We use TensorFlow for example, but could substitute other “define-before-run” frameworks like CNTK or MXNet. [↩](https://julialang.org/blog/2017/12/ml&pl#fnref:tf)

3.   TensorFlow’s graph is effectively a dataflow-based AST (Abstract Syntax Tree). [↩](https://julialang.org/blog/2017/12/ml&pl#fnref:ast)

4.   Though we note that, internally, current systems span the gamut from fully dynamic (PyTorch and its ATen backend) to unusually static (TensorFlow’s XLA and MXNet, where all dimensions are known before the graph is run). [↩](https://julialang.org/blog/2017/12/ml&pl#fnref:types)

5.   Google Brain’s increasing hiring of programming languages experts, such as [Chris Lattner](https://techcrunch.com/2017/08/14/swift-creator-chris-lattner-joins-google-brain-after-tesla-autopilot-stint/), is an interesting development on this point. [↩](https://julialang.org/blog/2017/12/ml&pl#fnref:chris)