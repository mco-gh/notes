...
![eleventy-i-static.jpg](../_resources/1050777cb022bc3511b2f0ed5f042fbc.jpg)
...
![eleventy-i-dynamic.jpg](../_resources/919504117abdc20fe2257e59cb84032d.jpg)
...
> Note> One could argue that applications and programs like Dreamweaver and FrontPage were the first static site generators that used a WYSIWYG editor. For brevity, I'm leaving that part of the history out.
...
> Note> Workarounds exist for all of these cons (and where appropriate, I've noted them) and some of them will be addressed in the SSG section, so hold your commenting horses.
...
> Note> *It’s a little confusing because to be accurate means we have to be pedantic, hence the redundancy of Generator-generated. For purposes of clarity, this is how I differentiated the two; please note the difference:
...
![eleventy-i-ssg.jpg](../_resources/4395727ef0012f94ef80152b5f5d7f84.jpg)
...
> Note> Next Time (Part II): I will teach you how to install Eleventy (and, all the things you need to to install in order to install Eleventy).
